...
public class Evaluator {
   ...
   */
   static RunConfig parseArgs (String[] params) {
      String typesFile = "forth2012types.txt";
      String specsFile = "forth2012specs.txt";
      String progFile = "examples.txt";
      int wordsCount = 0;
   ...
   static String usageText () {
      return "Usage: java evaluator.Evaluator [--types TYPES] " +
         "[--specs SPECS] [--prog PROGRAM] [word ...] " +
         "(defaults: forth2012types.txt, forth2012specs.txt, examples.txt)";
   } // end of usageText()
