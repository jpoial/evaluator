...
@dataclass
class Config:
    types: str = "forth2012types.txt"
    specs: str = "forth2012specs.txt"
    prog: Optional[str] = "examples.txt"
    words: list[str] = field(default_factory=list)


def usage() -> str:
    return ("Usage: python3 python3-evaluator.py [--types TYPES] [--specs SPECS] "
            "[--prog PROGRAM] [word ...] (defaults: forth2012types.txt, "
            "forth2012specs.txt, examples.txt)")
